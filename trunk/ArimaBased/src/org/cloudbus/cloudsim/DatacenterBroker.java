...
public class DatacenterBroker extends SimEntity {
	...
	protected void setDatacenterRequestedIdsList(List<Integer> datacenterRequestedIdsList) {
        ...
        public void sendCloudletToEntity(Cloudlet cloudlet, Datacenter datacenter, Vm vm, boolean allocate){


                cloudlet.setVmId(vm.getId());
                cloudlet.setUserId(vm.getUserId());
                 if(allocate){
                            this.getVmsToDatacentersMap().put(vm.getId(), datacenter.getId());
                            this.getVmList().add(vm);
                            //Ver como alocar getVmsToDatacenterMap
                          //  sendNow(3, CloudSimTags.CLOUDLET_SUBMIT, cloudlet);
                          //  this.getCloudletSubmittedList().add(cloudlet);
                          //  this.getVmsToDatacentersMap().put(vm.getId(), datacenter.getId());
                            sendNow(this.getVmsToDatacentersMap().get(vm.getId()), CloudSimTags.CLOUDLET_SUBMIT, cloudlet);
                            this.getCloudletSubmittedList().add(cloudlet);
                        //    System.out.println("\n\n\n\n\n\n\n\n\n\n" + cloudlet +"\n\n\n\n\n\n\n\n\n\n\n");
                 }
                else
