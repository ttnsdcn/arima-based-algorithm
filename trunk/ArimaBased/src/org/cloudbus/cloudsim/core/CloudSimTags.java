...
//    public static final double FNB_DROPPING_DELAY = 0.01; // 10 milliseconds
    ...
    public static final int BLOCKING_HOST = BASE + 43;

    public static final int UNBLOCKING_HOST = BASE + 44;

    public static final int MIDDLE_CICLE_FORECAST = BASE + 45;

    public static final int CLEAR_WAIT_QUEUE = BASE + 46;

    public static final int CLEAR_WAIT_QUEUE_ACK = BASE + 47;
